...
$mod_strings['LBL_LIST_FORM_TITLE'] = '标注列表';
$mod_strings['LBL_MODULE_NAME'] = '地图-标注';
$mod_strings['LBL_MODULE_TITLE'] = '地图-标注';
$mod_strings['LBL_HOMEPAGE_TITLE'] = '地图-标注';
$mod_strings['LNK_NEW_RECORD'] = '创建标注';
$mod_strings['LNK_LIST'] = '查看标注';
$mod_strings['LNK_IMPORT_JJWG_MARKERS'] = '导入标注';
$mod_strings['LBL_SEARCH_FORM_TITLE'] = '搜索';
$mod_strings['LBL_HISTORY_SUBPANEL_TITLE'] = '历史记录';
$mod_strings['LBL_ACTIVITIES_SUBPANEL_TITLE'] = '活动';
$mod_strings['LBL_NEW_FORM_TITLE'] = '新建';
$mod_strings['LBL_CITY'] = '城市';
$mod_strings['LBL_STATE'] = '省份'; //For address fields
...
$mod_strings['LBL_MARKER_MARKER_POSITION'] = '标注定位（纬度，经度）：';
$mod_strings['LBL_MARKER_CLOSEST_MATCHING_ADDRESS'] = '最近的匹配地址：';
$mod_strings['LBL_MARKER_MARKER_STATUS'] = '标注状态';
$mod_strings['LBL_MARKER_EDIT_DESCRIPTION'] = '点击并拖动标注。';
