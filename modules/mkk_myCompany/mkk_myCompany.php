...
class mkk_myCompany extends Company
{
    public $new_schema = true;
    public $module_dir = 'mkk_myCompany';
    public $object_name = 'mkk_myCompany';
    public $table_name = 'mkk_mycompany';
