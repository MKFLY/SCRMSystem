...
<div class="col-xs-12 col-sm-4 label" data-label="LBL_MKK_MYCOMPANY_ACCOUNTS_FROM_MKK_MYCOMPANY_TITLE">

{capture name="label" assign="label"}{sugar_translate label='LBL_MKK_MYCOMPANY_ACCOUNTS_FROM_MKK_MYCOMPANY_TITLE' module='Accounts'}{/capture}
{$label|strip_semicolon}:

</div>

<div class="col-xs-12 col-sm-8 edit-view-field " type="relate" field="mkk_mycompany_accounts_name"  >
{counter name="panelFieldCount" print=false}

<input type="text" name="{$fields.mkk_mycompany_accounts_name.name}" class="sqsEnabled" tabindex="" id="{$fields.mkk_mycompany_accounts_name.name}" size="" value="{$fields.mkk_mycompany_accounts_name.value}" title='' autocomplete="off"  	 >
<input type="hidden" name="{$fields.mkk_mycompany_accounts_name.id_name}" 
id="{$fields.mkk_mycompany_accounts_name.id_name}" 
value="{$fields.mkk_mycompany_accountsmkk_mycompany_ida.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.mkk_mycompany_accounts_name.name}" id="btn_{$fields.mkk_mycompany_accounts_name.name}" tabindex="" title="{sugar_translate label="LBL_SELECT_BUTTON_TITLE"}" class="button firstChild" value="{sugar_translate label="LBL_SELECT_BUTTON_LABEL"}"
onclick='open_popup(
"{$fields.mkk_mycompany_accounts_name.module}", 
600, 
400, 
"", 
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"mkk_mycompany_accountsmkk_mycompany_ida","name":"mkk_mycompany_accounts_name"}}{/literal}, 
"single", 
true
);' ><img src="{sugar_getimagepath file="id-ff-select.png"}"></button><button type="button" name="btn_clr_{$fields.mkk_mycompany_accounts_name.name}" id="btn_clr_{$fields.mkk_mycompany_accounts_name.name}" tabindex="" title="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_TITLE"}"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '{$fields.mkk_mycompany_accounts_name.name}', '{$fields.mkk_mycompany_accounts_name.id_name}');"  value="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_LABEL"}" ><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
<script type="text/javascript">
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['{$form_name}_{$fields.mkk_mycompany_accounts_name.name}']) != 'undefined'",
		enableQS
);
</script>
</div>
...
<input type="text" name="{$fields.parent_name.name}" class="sqsEnabled" tabindex="" id="{$fields.parent_name.name}" size="" value="{$fields.parent_name.value}" title='' autocomplete="off"  	 >
<input type="hidden" name="{$fields.parent_name.id_name}" 
id="{$fields.parent_name.id_name}" 
value="{$fields.parent_id.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.parent_name.name}" id="btn_{$fields.parent_name.name}" tabindex="" title="{sugar_translate label="LBL_ACCESSKEY_SELECT_ACCOUNTS_TITLE"}" class="button firstChild" value="{sugar_translate label="LBL_ACCESSKEY_SELECT_ACCOUNTS_LABEL"}"
onclick='open_popup(
...
"single", 
true
);' ><img src="{sugar_getimagepath file="id-ff-select.png"}"></button><button type="button" name="btn_clr_{$fields.parent_name.name}" id="btn_clr_{$fields.parent_name.name}" tabindex="" title="{sugar_translate label="LBL_ACCESSKEY_CLEAR_ACCOUNTS_TITLE"}"  class="button lastChild"
...
addToValidate('EditView', 'mkk_mycompany_accounts_name', 'relate', false,'{/literal}{sugar_translate label='LBL_MKK_MYCOMPANY_ACCOUNTS_FROM_MKK_MYCOMPANY_TITLE' module='Accounts' for_js=true}{literal}' );
...
addToValidateBinaryDependency('EditView', 'mkk_mycompany_accounts_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='Accounts' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_MKK_MYCOMPANY_ACCOUNTS_FROM_MKK_MYCOMPANY_TITLE' module='Accounts' for_js=true}{literal}', 'mkk_mycompany_accountsmkk_mycompany_ida' );
</script><script language="javascript">if(typeof sqs_objects == 'undefined'){var sqs_objects = new Array;}sqs_objects['EditView_assigned_user_name']={"form":"EditView","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name","assigned_user_id"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"\u6ca1\u6709\u5339\u914d"};sqs_objects['EditView_mkk_mycompany_accounts_name']={"form":"EditView","method":"query","modules":["mkk_myCompany"],"group":"or","field_list":["name","id"],"populate_list":["mkk_mycompany_accounts_name","mkk_mycompany_accountsmkk_mycompany_ida"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"\u6ca1\u6709\u5339\u914d"};sqs_objects['EditView_parent_name']={"form":"EditView","method":"query","modules":["Accounts"],"group":"or","field_list":["name","id"],"populate_list":["EditView_parent_name","parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"required_list":["parent_id"],"order":"name","limit":"30","no_match_text":"\u6ca1\u6709\u5339\u914d"};sqs_objects['EditView_campaign_name']={"form":"EditView","method":"query","modules":["Campaigns"],"group":"or","field_list":["name","id"],"populate_list":["campaign_id","campaign_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"required_list":["campaign_id"],"order":"name","limit":"30","no_match_text":"\u6ca1\u6709\u5339\u914d"};</script>{/literal}
