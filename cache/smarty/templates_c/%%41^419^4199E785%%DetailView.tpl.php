<?php /* Smarty version 2.6.29, created on 2018-01-17 13:31:00
         compiled from cache/themes/SuiteP/modules/mkk_myCompany/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/themes/SuiteP/modules/mkk_myCompany/DetailView.tpl', 40, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/mkk_myCompany/DetailView.tpl', 49, false),array('function', 'counter', 'cache/themes/SuiteP/modules/mkk_myCompany/DetailView.tpl', 107, false),array('function', 'sugar_getimage', 'cache/themes/SuiteP/modules/mkk_myCompany/DetailView.tpl', 120, false),array('function', 'sugar_phone', 'cache/themes/SuiteP/modules/mkk_myCompany/DetailView.tpl', 146, false),array('modifier', 'strip_semicolon', 'cache/themes/SuiteP/modules/mkk_myCompany/DetailView.tpl', 100, false),array('modifier', 'substr', 'cache/themes/SuiteP/modules/mkk_myCompany/DetailView.tpl', 183, false),array('modifier', 'to_url', 'cache/themes/SuiteP/modules/mkk_myCompany/DetailView.tpl', 185, false),array('modifier', 'escape', 'cache/themes/SuiteP/modules/mkk_myCompany/DetailView.tpl', 726, false),array('modifier', 'url2html', 'cache/themes/SuiteP/modules/mkk_myCompany/DetailView.tpl', 726, false),array('modifier', 'nl2br', 'cache/themes/SuiteP/modules/mkk_myCompany/DetailView.tpl', 726, false),)), $this); ?>
...
" class="button primary" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='mkk_myCompany'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='mkk_myCompany'; _form.return_action.value='DetailView'; _form.isDuplicate.value=true; _form.action.value='EditView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='mkk_myCompany'; _form.return_action.value='ListView'; _form.action.value='Delete'; if(confirm('<?php echo $this->_tpl_vars['APP']['NTC_DELETE_CONFIRMATION']; ?>
...
" class="button" onclick="var _form = document.getElementById('formDetailView'); _form.return_module.value='mkk_myCompany'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
<?php echo smarty_function_sugar_translate(array('label' => 'DEFAULT','module' => 'mkk_myCompany'), $this);?>
...
<?php if (! $this->_tpl_vars['fields']['mkk_mycompany_type']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>



<?php if (is_string ( $this->_tpl_vars['fields']['mkk_mycompany_type']['options'] )): ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['mkk_mycompany_type']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['mkk_mycompany_type']['options']; ?>
">
<?php echo $this->_tpl_vars['fields']['mkk_mycompany_type']['options']; ?>

<?php else: ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['mkk_mycompany_type']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['mkk_mycompany_type']['value']; ?>
">
<?php echo $this->_tpl_vars['fields']['mkk_mycompany_type']['options'][$this->_tpl_vars['fields']['mkk_mycompany_type']['value']]; ?>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_MODIFIED','module' => 'mkk_myCompany'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</div>
...
<?php $this->assign('value', "01/17/2018"); ?>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_ENTERED','module' => 'mkk_myCompany'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</div>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_BILLING_ADDRESS_STREET','module' => 'mkk_myCompany'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</div>
...
<?php endif; ?> 
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['billing_address_street']['name']; ?>
"><?php echo $this->_tpl_vars['fields']['billing_address_street']['value']; ?>
</span>
<?php endif; ?>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_SHIPPING_ADDRESS_STREET','module' => 'mkk_myCompany'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</div>
...
<?php endif; ?> 
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['shipping_address_street']['name']; ?>
"><?php echo $this->_tpl_vars['fields']['shipping_address_street']['value']; ?>
</span>
<?php endif; ?>
