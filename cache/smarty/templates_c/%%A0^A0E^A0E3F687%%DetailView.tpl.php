<?php /* Smarty version 2.6.29, created on 2018-01-16 09:08:16
...
<div class="buttons">
<input title="编辑" accessKey="i" name="Edit" id="edit_button" value="编辑" onclick="var _form = document.getElementById('formDetailView');_form.return_module.value='Users'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $this->_tpl_vars['fields']['id']['value']; ?>
'; _form.action.value='EditView';_form.submit();" type="button"/>
<input id="duplicate_button" title="复制" accessKey="u" class="button" onclick="var _form = document.getElementById('formDetailView');_form.return_module.value='Users'; _form.return_action.value='DetailView'; _form.isDuplicate.value=true; _form.action.value='EditView';_form.submit();" type="button" name="Duplicate" value="复制"/>
<input title="重置密码" class="button" LANGUAGE="javascript" onclick="generatepwd('<?php echo $this->_tpl_vars['fields']['id']['value']; ?>
');" type="button" name="password" value="重置密码"/>
<input title="重置首选项" class="button" LANGUAGE="javascript" onclick="if(confirm('您确定要重置此用户的所有首选项？')) window.location='index.php?module=Users&action=resetPreferences&reset_preferences=true&record=<?php echo $this->_tpl_vars['fields']['id']['value']; ?>
';" type="button" name="password" value="重置首选项"/>
<input title="重置首页" class="button" LANGUAGE="javascript" onclick="if(confirm('您确定要重置首页？')) window.location='index.php?module=Users&action=DetailView&reset_homepage=true&record=<?php echo $this->_tpl_vars['fields']['id']['value']; ?>
';" type="button" name="password" value="重置首页"/>
...
<li role="presentation">
<a data-toggle="tab" id="tab0" href="#">高级</a>
</li>
<?php if ($this->_tpl_vars['SHOW_ROLES'] == true): ?>
<li role="presentation">
<a data-toggle="tab" id="tab0" href="#">访问</a>
</li>
<?php endif; ?>
</ul>
</li>
...
<a data-toggle="tab" id="tab1" href="#">高级</a>
</li>
<?php if ($this->_tpl_vars['SHOW_ROLES']): ?>
<li role="presentation" class="hidden-xs ">
<a data-toggle="tab" id="tab2" href="#">访问</a>
</li>
<?php endif; ?>
<?php if ($this->_tpl_vars['config']['enable_action_menu']): ?>
...
<li><input title="编辑" accessKey="i" name="Edit" id="edit_button" value="编辑" onclick="var _form = document.getElementById('formDetailView');_form.return_module.value='Users'; _form.return_action.value='DetailView'; _form.return_id.value='<?php echo $this->_tpl_vars['fields']['id']['value']; ?>
'; _form.action.value='EditView';_form.submit();" type="button"/></li>
<li><input id="duplicate_button" title="复制" accessKey="u" class="button" onclick="var _form = document.getElementById('formDetailView');_form.return_module.value='Users'; _form.return_action.value='DetailView'; _form.isDuplicate.value=true; _form.action.value='EditView';_form.submit();" type="button" name="Duplicate" value="复制"/></li>
<li><input title="重置密码" class="button" LANGUAGE="javascript" onclick="generatepwd('<?php echo $this->_tpl_vars['fields']['id']['value']; ?>
');" type="button" name="password" value="重置密码"/></li>
<li><input title="重置首选项" class="button" LANGUAGE="javascript" onclick="if(confirm('您确定要重置此用户的所有首选项？')) window.location='index.php?module=Users&action=resetPreferences&reset_preferences=true&record=<?php echo $this->_tpl_vars['fields']['id']['value']; ?>
';" type="button" name="password" value="重置首选项"/></li>
<li><input title="重置首页" class="button" LANGUAGE="javascript" onclick="if(confirm('您确定要重置首页？')) window.location='index.php?module=Users&action=DetailView&reset_homepage=true&record=<?php echo $this->_tpl_vars['fields']['id']['value']; ?>
';" type="button" name="password" value="重置首页"/></li>
